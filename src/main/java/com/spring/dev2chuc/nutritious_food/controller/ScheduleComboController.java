...
public class ScheduleComboController {
    ...
    public ResponseEntity<?> getDetail(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<>(new ApiResponseCustom<>(HttpStatus.OK.value(), "OK", scheduleCombo), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getAllByScheduleId(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<>(new ApiResponseCustom<>(HttpStatus.OK.value(), "OK", scheduleCombos), HttpStatus.OK);
    }
